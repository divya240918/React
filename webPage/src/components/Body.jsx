...
function Body() {
  return (
    <>
      <div className='m-2 bg-red-400 min-h-200'>
        <div className='flex flex-wrap gap-10 p-10 justify-center'>
          <div className='bg-blue-400 h-60 w-60 rounded-xl shadow-xl flex flex-col items-center justify-center'>
            <img
              className='h-40 m-5 rounded-lg shadow-md '
              src="./public/gelpen.png" alt="" />
            <div className='text-white font-semibold flex gap-12 mb-2'>
              <h4>Gel Pen</h4>
              <button className='bg-red-400 w-10 rounded-md shadow-md text-sm'>Add</button>
            </div>
          </div>
          <div className='bg-blue-400 h-60 w-60 rounded-xl shadow-xl flex flex-col items-center justify-center'>
            <img
